...
const checks = [
  ...
  ['manual refresh button exists inside sync accordion', corpus.includes("'contacts.refreshFromAccount'") && html.includes('data-contacts-accordion="sync"')],
  ['manual upload button exists', corpus.includes("'contacts.uploadLocal'")],
  ['signed-in copy says contacts sync automatically', main.includes("t('contacts.syncedAuto')")],
  ['signed-out copy says contacts stay local', main.includes("t('contacts.localOnly')")],
  ...
  ['top add contact CTA exists', html.includes('id="contacts-add-cta"') && corpus.includes("'contacts.addContact'")],
  ...
  ['add contact form has close control', html.includes('data-close-add-contact') && corpus.includes("'common.close'")],
